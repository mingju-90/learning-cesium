...
const getLat = (geometry) => {
    console.log('geometry.attributes.position.values', geometry)
...
export class CreateFrustum {
    ...
    _addFrustum() {
        ...
        console.log('orientation',  getCesiumHPRFromDjiSpecifications(this._position, this._yaw, this._pitch))
